...
/**
 * do_compute: the entry of your code that implements the K-Means algorithm
 * \param p: the input of K-Means, including minimum changes between iterations, maximum iterations, coordinates of points, etc.
 * \param r: result of your implementation (also includes the initial centroids. you need to store the final centroids here)
 * This function is declared here to support the header for both C and C++ (nvcc).
 */
...
int main(int argc, char **argv) {
     ...
     * than this precision, the algorithm stops. argv[6]: Output file. Class
     * assigned to each point of the input file.
     * */
    if (argc != 7) {
        fprintf(stderr, "EXECUTION ERROR K-MEANS: Parameters are not correct.\n");
        fprintf(stderr, "./KMEANS <Input Filename> <Number of clusters> <Number of "
    ...
    // this is the entry point of your code. Please do not modify this file
    printf("Going into do_compute\n");
    fflush(stdout);
    ...
    // printf("\nComputation (with mem alloc and init): %f seconds", duration);
    fflush(stdout);
    //**************************************************
    // ----------------------- Computation End ---------------------------
